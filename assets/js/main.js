...
(function () {
  var searchData = [
    ...
    { title:'累計贊助禮包', path:'pages/event-sponsor-gift.html', keywords:'贊助 禮包 累計 金赦同歡慶 金赦崛起 金赦征途 金赦霸主 金赦之父 金赦至尊 傳說變身 傳說娃娃' },
  ...
  overlay.innerHTML =
    ...
    '<div class="search-overlay__box">' + '<div class="search-overlay__label">◈ 金赦天堂 · 全站搜尋</div>' +
